...
<head>
    ...
    <title>Max24x7 | Admin-Enquiry Details</title>
    ...
    <div class="container">
        <header class="d-flex">
            ...
            <nav>
                <ul class="d-flex">
                    ...
                    <li><a href="enquiry.php" class="nav_links" id="current_active">Enquiry</a></li>
        ...
        <section class="section_datacontainer d-flex">
            ...
            <div class="img_container">
                <img src="../images/adminenquiry.jpg" alt="">
            </div>
                ...
                <div class="table">
                    ...
                    <table class="table-content">
                        ...
                        <tbody>
                            ...
                            $select_enquiry = "SELECT * FROM enquiry_form";
                            $process_query = mysqli_query($connect_to, $select_enquiry);

                            while ($result = mysqli_fetch_array($process_query)) {
                            ?>
                                <tr>
                                    <td><?php echo $result["Enquiry_id"] ?></td>
                                    <td><?php echo $result["Main_service_name"] ?></td>
                                    <td><?php echo $result["Client_name"] ?></td>
                                    <td><?php echo $result["Asked_date"] ?></td>
                                    <td><?php echo $result["Asked_time"] ?></td>
                                    <td><?php echo $result["Client_phone"] ?></td>
                                    <td><a href="../action/deleteenquiryaction.php?Enquiry_id=<?php echo $result["Enquiry_id"] ?>" class="delete"><i class="fas fa-trash-alt"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
