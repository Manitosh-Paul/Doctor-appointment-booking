<?php
session_start();
if (!isset($_SESSION["admin_fname"]) && !isset($_SESSION["Admin_email"])) {
...
<head>
    ...
    <title>Max24x7 | Admin-Admins</title>
...
<body>
    <div class="container">
        <header class="d-flex">
            ...
            <nav>
                <ul class="d-flex">
                    <li><a href="admins.php" class="nav_links" id="current_active">Admins</a></li>
        ...
        <section class="section_datacontainer d-flex">
            ...
            <div class="img_container">
                <img src="../images/adminpanel.jpg" alt="admins">
            </div>
            <div class="table_container d-flex">
                <div class="table">
                    ...
                    $check_which_admin = "Select Admin_type from max_admin where admin_email = '$admin_email'";
                    $process_check = mysqli_query($connect_to, $check_which_admin);
                    $check_result = mysqli_fetch_array($process_check);
                    if (!($check_result['Admin_type'] == "test")) {
                        include 'mainadmins.php';
                    } else {
                        include 'testadmins.php';
                    }
                    ?>
                </div>
            </div>
