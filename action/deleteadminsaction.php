            ...
            <section class="messgae_container">
                <div class="message d-flex">
                    ...
                    <div class="btns_container">
                        <button><a href="confirmadminsdelete.php?confirm=<?php echo $admin_email ?>">Ok</a></button>
                        <button id="cancel_btn"><a href="../admin/admins.php">Cancel</a></button>
                    </div>
                </div>
                <picture>
                    <source media="(max-width: 426px)" srcset="../images\responsive_img\adminpanel\adminpanel-425w.png">
                    <source media="(max-width: 768px)" srcset="../images\responsive_img\adminpanel\adminpanel-768w.png">
                    <img src="../images\responsive_img\adminpanel\adminpanel-1400w.png" alt="bg-image">
                </picture>
