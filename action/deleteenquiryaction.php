            ...
            <section class="messgae_container">
                <div class="message d-flex">
                    ...
                    <div class="btns_container">
                        <button><a href="confirmdeleteenquiry.php?confirm=<?php echo $Enquiry_id ?>">Ok</a></button>
                        <button id="cancel_btn"><a href="../admin/enquiry.php">Cancel</a></button>
                    </div>
                </div>
                <picture>
                    <source media="(max-width: 426px)" srcset="../images\responsive_img\enquiry_delete\enquiry_delete_425w.png">
                    <source media="(max-width: 768px)" srcset="../images\responsive_img\enquiry_delete\enquiry_delete_768w.png">
                    <img src="../images\responsive_img\enquiry_delete\enquiry_delete_1400w.png" alt="bg-image">
                </picture>
